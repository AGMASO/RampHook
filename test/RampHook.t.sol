...
contract RampHookTest is Test, Deployers {
    ...
    function setUp() public {
        ...
        MockERC20 _currencyA = new MockERC20("FakeUsdc", "USDC", 18);
        address usdcTokenAddress = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
        vm.etch(usdcTokenAddress, address(_currencyA).code);
        _currencyA = MockERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
        _currencyA.mint(address(this), type(uint256).max);
    ...
    function test_onRampNoMatchNormalSwap() public {
        ...
        console2.log(
            "USER2 balance currency0 before swap matched: %s",
            s_key.currency0.balanceOf(USER2)
        );
        console2.log(
            "USER2 balance currency1 before swap matched: %s",
            s_key.currency1.balanceOf(USER2)
        );
        swapRouter.swap(
            key,
