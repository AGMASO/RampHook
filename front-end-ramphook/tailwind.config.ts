  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "matrix-fade": "matrix-pills-fade 5s ease-in-out forwards",
        "options-fade": "options-fade-in 4s ease-in-out forwards 1s",
      },
    },
  },
